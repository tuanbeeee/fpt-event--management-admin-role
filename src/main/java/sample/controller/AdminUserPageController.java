 ...
 * @author light
 */
@WebServlet(name = "AdminUserPageController", urlPatterns = {"/AdminUserPageController"})
public class AdminUserPageController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            listUsers = new UserDAO().getAllUsers();
            request.setAttribute("LIST_USERS", listUsers);
            url = SUCCESS;
        } catch (Exception e) {
            log("Error at Admin User Page Controller" + e.toString());
        } finally {
