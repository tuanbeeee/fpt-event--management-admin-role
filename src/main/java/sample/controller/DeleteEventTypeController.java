 ...
 * @author light
 */
@WebServlet(name = "DeleteEventTypeController", urlPatterns = {"/DeleteEventTypeController"})
public class DeleteEventTypeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at DeleteEventTypeController " + e.toString());
        } finally {
