                    ...
                    <div class="menu-area">
                        <ul class="menu">
                            <li>
                                ...
                                <a href="homepage.jsp" ><i class="icofont-home"></i>Home</a>
                            </li>
                        ...
                        <i class="icofont-login"></i><a href="login.jsp">Log In/</a>
                        
                        <i class="icofont-user"></i><a href="RegisterController">Sign Up</a>
            ...
            <div class="section-wrapper">
                <div class="zero-item">
                    <div class="zero-thumb">
                        <img src="UserCSS/kagont/assets/images/404.png" alt="404">
                    </div>
                    <div class="zero-content">
                        ...
                        <a href="index.html" class="lab-btn"><span>Go Back to Home <i
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="footer-top-item lab-item">
                            <div class="lab-inner">
                                ...
                                <div class="lab-content">
                                    <span>Email : admin@UserCSS/Kagont.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="footer-middle-item-wrapper">
                            <div class="footer-middle-item mb-5 mb-lg-0">
                                <div class="fm-item-title">
                                    <h5>About UserCSS/Kagont</h5>
                                </div>
                                <div class="fm-item-content">
                                    <p class="mb-30">Energistica coordinate highly eficient procesr
                                        improvement viaing awesome</p>
                                    <img class="rounded footer-abt-img" src="UserCSS/kagont/assets/images/footer/footer-middle/01.jpg"
                                        alt="about-image">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="fm-item-content">
                                    <div class="fm-item-widget lab-item">
                                        <div class="lab-inner">
                                            <div class="lab-thumb">
                                                <a href="#">
                                                    <img src="UserCSS/kagont/assets/images/footer/footer-middle/02.jpg"
                                    ...
                                    <div class="fm-item-widget lab-item">
                                        <div class="lab-inner">
                                            <div class="lab-thumb">
                                                <a href="#"><img src="UserCSS/kagont/assets/images/footer/footer-middle/03.jpg"
                                    ...
                                    <div class="fm-item-widget lab-item">
                                        <div class="lab-inner">
                                            <div class="lab-thumb">
                                                <a href="#"><img src="UserCSS/kagont/assets/images/footer/footer-middle/04.jpg"
                                                        alt="footer-widget-img"></a>
                                            </div>
                                            <div class="lab-content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="footer-middle-item-wrapper">
                            <div class="footer-middle-item-3 mb-5 mb-lg-0">
                                ...
                                <div class="fm-item-content">
                                    <p>UserCSS/Kagont is a event organization supported
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-bottom-content text-center">
                            <p>&copy;2021 <a href="index.html">UserCSS/Kagont</a> -Best For Event HTML Template.</p>
                        </div>
                    </div>
                </div>
            </div>
